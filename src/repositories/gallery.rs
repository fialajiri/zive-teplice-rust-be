...
impl GalleryRepository {
    ...
    pub async fn create(c: &mut AsyncPgConnection, new_gallery: NewGallery) -> QueryResult<Gallery> {
    ...
    pub async fn update(c: &mut AsyncPgConnection, id: i32, gallery: UpdateGallery) -> QueryResult<Gallery> {
    ...
    pub async fn remove_images(
        ...
        diesel::delete(
            gallery_images::table.filter(
                gallery_images::gallery_id.eq(gallery_id)
